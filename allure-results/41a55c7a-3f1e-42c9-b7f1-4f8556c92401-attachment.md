      ...
      - list [ref=e14]:
        ...
        - listitem [ref=e23]:
          - link " Wish List (0)" [ref=e24] [cursor=pointer]:
            - /url: http://localhost/opencart/upload/index.php?route=account/wishlist&language=en-gb&customer_token=8228e536b35486f31189df96bb
            - generic [ref=e25]: 
            - text: Wish List (0)
        - listitem [ref=e26]:
              ...
              - cell "2  " [ref=e99]:
                - generic [ref=e101]:
                  ...
                  - link "" [ref=e105] [cursor=pointer]:
                    - /url: http://localhost/opencart/upload/index.php?route=checkout/cart.remove&language=en-gb&key=27
                    - generic [ref=e106]: 
          ...
          - list [ref=e162]:
            ...
            - listitem [ref=e165]:
              - link "Affiliate" [ref=e166] [cursor=pointer]:
                - /url: http://localhost/opencart/upload/index.php?route=account/affiliate&language=en-gb&customer_token=8228e536b35486f31189df96bb
            - listitem [ref=e167]:
              - link "Specials" [ref=e168] [cursor=pointer]:
                - /url: http://localhost/opencart/upload/index.php?route=product/special&language=en-gb&customer_token=8228e536b35486f31189df96bb
        - generic [ref=e169]:
          - heading "My Account" [level=5] [ref=e170]
          - list [ref=e171]:
            - listitem [ref=e172]:
              - link "My Account" [ref=e173] [cursor=pointer]:
                - /url: http://localhost/opencart/upload/index.php?route=account/account&language=en-gb&customer_token=8228e536b35486f31189df96bb
            - listitem [ref=e174]:
              - link "Order History" [ref=e175] [cursor=pointer]:
                - /url: http://localhost/opencart/upload/index.php?route=account/order&language=en-gb&customer_token=8228e536b35486f31189df96bb
            - listitem [ref=e176]:
              - link "Wish List" [ref=e177] [cursor=pointer]:
                - /url: http://localhost/opencart/upload/index.php?route=account/wishlist&language=en-gb&customer_token=8228e536b35486f31189df96bb
            - listitem [ref=e178]:
              - link "Newsletter" [ref=e179] [cursor=pointer]:
                - /url: http://localhost/opencart/upload/index.php?route=account/newsletter&language=en-gb&customer_token=8228e536b35486f31189df96bb
      - separator [ref=e180]
      - paragraph [ref=e181]:
        - text: Powered By
